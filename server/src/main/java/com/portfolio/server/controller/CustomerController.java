...
import com.portfolio.server.repository.CustomerRepository;
...
public class CustomerController {
    ...
    public Customer postCustomer(@RequestBody Customer customer) {
        Customer _customer = repository.save(
                new Customer(customer.getName(), customer.getAge()));
    ...
    public List<Customer> findCustomerByAge(@PathVariable int age) {
        List<Customer> customers = repository.findCustomerByAge(age);
